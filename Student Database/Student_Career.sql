...
select Job_Goal,avg(Expected_salary) as avg_exp_salary
from StudentCareer
group by Job_Goal
...
select Student_Name,
       Experience_Years,
       case
           when Experience_Years = 0.0 then 'Fresher'
           when Experience_Years between 0.5 and 1.0 then 'Junior'
           else 'Experienced'
...
select Student_Name,
       ...
       case
           ...
           when Expected_Salary between 700000 and 850000 then 'Medium'
           else 'High'
